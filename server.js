...
sparkBot.on('message', function (event)
{
  var sentMessage = "";
    ...
    if (String(event.person.displayname) === 'Juan test') {
      ...
      sentMessage = String(event.person.displayname) + "  test";//'sorry, I can only talk with the great maker#' + event.person.displayName+'#Alone';
    }
